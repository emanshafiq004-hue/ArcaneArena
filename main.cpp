...
int main()
{
    try
    {
        ...
        while (running && gameWindow.isOpen())
        {
            ...
            {
                gameWindow.getAudio().Stop();
                IronFist ironFist(gameWindow, gameWindow.getAudio()); ironFist.run();
                break;
            }
            case 3:
            {
                gameWindow.getAudio().Stop();
                ShatterShift shatter(gameWindow, gameWindow.getAudio()); shatter.run();
                break;
            }
            case 4:
            {
                ...
                SkySurge skySurge(gameWindow,gameWindow.getAudio()); skySurge.run();
